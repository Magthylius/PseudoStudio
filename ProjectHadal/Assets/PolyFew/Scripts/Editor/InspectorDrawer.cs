...
#pragma warning disable
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isFeasibleTargetForPolyFew)
            {
                ...
                if(isPlainSkin)
                {
                    if (GUILayout.Button("<size=14><b>POLY FEW</b></size> <size=7><b>v7.20</b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                else
                {
                    if (GUILayout.Button("<size=14><color=#A52A2AFF><b>POLY FEW</b></color></size> <size=7><b><color=#A52A2AFF>v7.20</color></b></size>", style)) { toolMainFoldout = !toolMainFoldout; }
                }
                ...
                if (GUILayout.Button(content, GUILayout.Width(24), GUILayout.Height(24)))
                {
                    Application.OpenURL("https://brainfail.000webhostapp.com/polyfew_site");
                }
                ...
                if (GUILayout.Button(content, GUILayout.Width(24), GUILayout.Height(24)))  
                {
                    if (lastRect != null)
                    {
                        ...
                        definitions.Add(new PopupToggleTemplate.ToggleDefinition(content, 190, -4, null, null, true, () =>
                        {
                            ...
                            if (didPressButton)
                            {
                                PolyfewMenu.RemoveLODBackupComponents();
                            }
