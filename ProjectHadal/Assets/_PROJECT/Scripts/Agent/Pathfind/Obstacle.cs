...
{
	/// <summary>
    /// What a generic obstacle should have
    /// </summary>
	...
	/// <summary>
    /// Obstacle implementation for octree and pathfinding usage
    /// </summary>
	public sealed class Obstacle : ObstacleBase
	{
		...
		/// <summary> 
        /// Used to record the changed/unchanged period within m_PeriodMin ~ m_PeriodMax,
		/// when the state does not change for a long while, it will be considered Inactive.
        /// <br/>
        /// If an obstacle is changed more frequently, the next update time will be reduced down to at least <see cref="m_PeriodMin"/>;
        /// If an obstacle is changed less frequently, the next update time will be increased up to at most <see cref="m_PeriodMax"/>.
		/// </summary>
		private float m_PeriodicUpdate;
		
		/// <summary>Next update time since level loaded. This is a necessary optimization for performace reasons.</summary>
		...
		/// <summary>
        /// This is an Update function for the Obstacle. To update its status to the latest information. You can call this a
        /// Delayed Update
        /// </summary>
