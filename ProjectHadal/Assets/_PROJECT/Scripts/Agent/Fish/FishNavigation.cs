...
namespace Hadal.AI
{
    public class FishNavigation : MonoBehaviour
    {
        ...
        private List<FishNavigation> cohesionNeighbours = new List<FishNavigation>();
        private List<FishNavigation> avoidanceNeighbours = new List<FishNavigation>();
        private List<FishNavigation> aligementNeighbours = new List<FishNavigation>();
        private FishManager assignedFlock;
        ...
        public void AssignFlock(FishManager flock)
        {
            assignedFlock = flock;
        }
