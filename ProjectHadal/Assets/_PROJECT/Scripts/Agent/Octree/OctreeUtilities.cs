...
namespace FlyAgent.Navigation
{
	...
	/// <summary>
    /// A class that holds data for merge requests by nodes with obstacles. This merge request will have a higher priority in a queue
    /// based on the size of the node the request is coming from.
    /// </summary>
	...
	/// <summary>
    /// Request for rebuilding the octree every update frame
    /// </summary>
