        ...
        SubShader
        {
            ...
            Pass // !Multiple pass blocks can be defined, but not recommended, just use a different shader/material
            {
                ...
                Varyings vert(Attributes IN)
                {
                    ...
                    float3 v0 = IN.positionOS.xyz;
                    float3 bitangent = cross(IN.normalOS, IN.tangentOS.xyz);
                    float3 v1 = v0 + (IN.tangentOS.xyz * 0.01);
                    ...
                    normalInputs.normalWS = normalize(vn);
